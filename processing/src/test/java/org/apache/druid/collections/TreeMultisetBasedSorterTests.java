...
public class TreeMultisetBasedSorterTests extends SorterTests
{
  @Test
  public void singleColumnAscSort()
  {
    ...
    TreeMultisetBasedSorter multiColumnSorter = new TreeMultisetBasedSorter(comparator);
  ...
  public void multiColumnSort()
  {
    ...
    Comparator<Sorter.SorterElement<Integer>> comparator = getMultiColumnSorterElementComparator(orderByDirection);
    TreeMultisetBasedSorter multiColumnSorter = new TreeMultisetBasedSorter(comparator);
    multiColumnSortDatas(multiColumnSorter, new ArrayList<>());
    Iterator<Integer> it = multiColumnSorter.drain(5);
  ...
  {
    List<String> orderByDirection = ImmutableList.of("ASCENDING", "DESCENDING", "DESCENDING");
    TreeMultisetBasedSorter multiColumnSorter = new TreeMultisetBasedSorter(getMultiColumnSorterElementComparator(
        orderByDirection));
